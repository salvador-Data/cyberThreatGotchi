...
window.HPL_SHIPPING = {
  ...
  products: {
    ...
    bleBot: { fulfillment: "direct", weightOz: 18, category: "hardware" },
    ...
    mspMonitor: { fulfillment: "digital", weightOz: 0, category: "service" },
    mspDefend: { fulfillment: "digital", weightOz: 0, category: "service" },
    mspHarden: { fulfillment: "digital", weightOz: 0, category: "service" },
