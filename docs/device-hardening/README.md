...
| Area | Contents |
|------|----------|
| **iPhone + laptop** | Honest scope docs (no MAC spoofing from Windows); read-only PowerShell checklist |
| **IDS/IPS** | Links to Snort/Suricata stacks; network vs RAM exploit table |
| **CPU mitigations** | Windows `Update-CtgExploitMitigations.ps1`, Kali `ctg-exploit-mitigations-check.sh` |
...
See `docs/IPHONE_LAPTOP_CONNECTION.md`.
...
Signal/IDS scripts in the monorepo are **unchanged** by mitigation helpers.
