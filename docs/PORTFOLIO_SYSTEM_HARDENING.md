...
| Network | OPNsense + Suricata (documented edge); Kali analyst VM — [KALI_LAB_ARCHITECTURE.md](KALI_LAB_ARCHITECTURE.md) · `Deploy-KaliLab.ps1` |
